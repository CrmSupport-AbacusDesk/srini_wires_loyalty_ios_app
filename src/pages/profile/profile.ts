...
export class ProfilePage {
    ...
    {
        let image = "";
        let app_url = "https://apps.apple.com/us/app/srini-link-loyalty-is-royalty/id6443667812";
